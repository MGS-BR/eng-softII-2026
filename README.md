# eng-softII-2026
Projeto da Disciplina de Engenharia de Softaware II do curso de ADS da Fatec Sorocaba
1. Contabilidade Ágil
2. Desenvolver uma aplicação que realize os lançamentos contábeis através de IA de acordo com os documentos enviados pelo cliente.
   O Contador(Administrador) deve ser capaz de realizar a alteração dos lançamentos se necessário.
